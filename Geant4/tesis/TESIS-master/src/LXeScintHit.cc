...
LXeScintHit::LXeScintHit() : fEdep(0.), fPos(0.), fPhysVol(0), fparticle(0) {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

LXeScintHit::LXeScintHit(G4VPhysicalVolume* pVol, G4ParticleDefinition* pPart) : fPhysVol(pVol), fparticle(pPart) {}
